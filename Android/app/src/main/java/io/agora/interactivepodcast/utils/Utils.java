package io.agora.interactivepodcast.utils;
...
public class Utils {
    ...
    public static String getTokenUrl(){
        ...
        return restServer + "/" + keyArrys[0] + "/" + keyArrys[1] + "/token";
    }
    ...
    public static String createChatRoomUrl(){
        ...
        String[] keyArrys = appKey.split("#");
        String restServer = EMClient.getInstance().getOptions().getRestServer();
        EMLog.e("hatRoomUrl", "createChatRoomUrl: "+restServer );
        if (TextUtils.isEmpty(restServer)){
            restServer = "https://a4-v2.easemob.com:443";
        }
    ...
    public static void hideKeyboard(View view){
        InputMethodManager imm = (InputMethodManager) AppApplication.getInstance().getApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE);
