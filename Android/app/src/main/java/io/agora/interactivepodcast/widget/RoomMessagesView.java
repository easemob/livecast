...
//        closeView = (ImageView) findViewById(R.id.close_image);
    ...
    public void init(String chatroomId){
        ...
        SyLinearLayoutManager linearLayoutManager = new SyLinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
                ...
                public void keyboardShow(int height) {
                    ...
                    startAnimation(height, 100, new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public void onAnimationUpdate(ValueAnimator animation) {
                            ...
                            Log.e("wyz","keyboardShow  value : "+value);
...
//            String nickName = DemoHelper.getNickName(from);
        ...
        private void showText(TextView name, String nickName, boolean isSelf, String content) {
            ...
            SpannableString span = new SpannableString(builder.toString());
            span.setSpan(new ForegroundColorSpan(isSelf ? ContextCompat.getColor(getContext(), R.color.color_room_manager_orange) : ContextCompat.getColor(getContext(), R.color.color_room_my_msg) ),
                    0, nickName.length() + 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            span.setSpan(new ForegroundColorSpan(ContextCompat.getColor(getContext(), R.color.common_white)), nickName.length()+1,builder.length() , Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
