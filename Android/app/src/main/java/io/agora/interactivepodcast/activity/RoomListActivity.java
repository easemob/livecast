                ...
                .subscribe(new DataMaybeObserver<List<Room>>(this) {
                    ...
                    public void handleSuccess(@Nullable List<Room> rooms) {
                        ...
                        if (rooms == null) {
                            ...
                            EMLog.e(TAG,"  loadRooms()  () "+rooms.size());
...
//        overridePendingTransition(R.anim.chat_room_in, R.anim.chat_room_out);
        ...
        Intent intent = ChatRoomTestActivity.newIntent(this,room);
        startActivity(intent);
        overridePendingTransition(R.anim.chat_room_in, R.anim.chat_room_out);
    }
    ...
    private void exitRoom() {
        if (isOwner()){//群主解散聊天室
            ChatRoomManager.getInstance().destroyChatRoom(RoomManager.Instance(this).getRoom().getChatroomId(), new EMCallBack() {
                @Override
                public void onSuccess() {
                    EMLog.e(TAG," destroyChatRoom    onSuccess()  ");
                ...
                public void onError(int i, String s) {
                    EMLog.e(TAG," destroyChatRoom    onError()  code  "+i+" ; msg +s");
                }
    ...
    public void onItemClick(@NonNull Room data, View view, int position, long id) {
        ...
        this.mRoom = data;
        ChatRoomManager.getInstance().joinChatRoom(data.getChatroomId(), new EMValueCallBack<EMChatRoom>() {
            @Override
            public void onSuccess(EMChatRoom emChatRoom) {
                //FIXME
//                Intent intent = ChatRoomActivity.newIntent(RoomListActivity.this, data);
//                startActivity(intent);
                startActivity(ChatRoomTestActivity.newIntent(RoomListActivity.this, data));
            }

            @Override
            public void onError(int i, String s) {
                EMLog.e(TAG,"msg : "+s+"  code : "+i);
            }
        });
    ...
    public void onOwnerLeaveRoom(@NonNull Room room) {
        ...
        mDataBinding.btCrateRoom.setVisibility(View.VISIBLE);
        mDataBinding.llMin.setVisibility(View.GONE);
        ChatRoomManager.getInstance().destroyChatRoom(room.getChatroomId(), new EMCallBack() {
            @Override
            public void onSuccess() { }
